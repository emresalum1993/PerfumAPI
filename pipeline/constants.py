...
# AI overview (separate from mood scoring)
AI_OVERVIEW_MAX_REVIEWS_PER_SENTIMENT = int(
    os.getenv("AI_OVERVIEW_MAX_REVIEWS_PER_SENTIMENT", "20")
)
AI_OVERVIEW_REVIEW_CHAR_LIMIT = int(os.getenv("AI_OVERVIEW_REVIEW_CHAR_LIMIT", "600"))
AI_OVERVIEW_MAX_ATTEMPTS = int(os.getenv("AI_OVERVIEW_MAX_ATTEMPTS", "3"))
AI_OVERVIEW_TEMPERATURE = float(os.getenv("AI_OVERVIEW_TEMPERATURE", "0.3"))
AI_OVERVIEW_VERBATIM_MIN_WORDS = int(os.getenv("AI_OVERVIEW_VERBATIM_MIN_WORDS", "6"))
